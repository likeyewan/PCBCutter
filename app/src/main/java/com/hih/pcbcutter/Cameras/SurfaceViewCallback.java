 ...
 * 相机界面SurfaceView的回调类
 */
final class SurfaceViewCallback implements SurfaceHolder.Callback, Camera.PreviewCallback {

    private Context context;
    private static final String TAG = "Camera";
    private final FrontCamera mFrontCamera = new FrontCamera();
    private final boolean previewing = mFrontCamera.getPreviewing();
